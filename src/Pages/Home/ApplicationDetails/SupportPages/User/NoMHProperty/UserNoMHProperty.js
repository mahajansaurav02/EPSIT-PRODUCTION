            ...
            <>
              <Grid item md={12} mt={1}>
                <InputLabel className="inputlabel">
                  <b>
                    अर्जदारचे नाव <span> *</span> (नाव टाइप केल्यावर स्पेस बार
                    दाबा. उ.दा.:- mahesh &gt;&gt; महेश)
                  </b>
                </InputLabel>
                <Grid container justifyContent="space-between" alignItems="end">
                  <Grid item md={2}>
              ...
              <Grid item md={12}>
                <Grid item md={12} mt={1}>
                  <InputLabel className="inputlabel">
                    <b>
                      अर्जदारचे नाव <span> *</span> (इंग्रजी मध्ये)
                    </b>
                  </InputLabel>
                  <Grid container justifyContent="space-between">
                    <Grid item md={2}>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <>
                            ...
                            />
                            <FormHelperText sx={{ color: "red" }}>
                              {errors.middleNameEng &&
                                errors.middleNameEng.message}
                            </FormHelperText>
                          </>
                        )}
                      />
