            ...
            <Grid container spacing={2}>
              ...
              <Grid item md={4}>
                ...
                <Select
                  ...
                  size="small"
                >
                  <MenuItem value="aapak1">अ.पा.क/ए.कू.मॅ - 1</MenuItem>
                  <MenuItem value="aapak2">अ.पा.क/ए.कू.मॅ - 2</MenuItem>
                </Select>
              </Grid>
              <Grid item md={4}>
                <InputLabel className={styles.inputlabel}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item md={4}>
                {radio == "yes" ? (
                  <>
                    <InputLabel className={styles.inputlabel}>
                      <b>ए.कू.मॅ. देणार क्षेत्र (चौ.मी.)</b>
                    </InputLabel>
                    <TextField fullWidth size="small" value={40} disabled />
                  </>
                ) : (
