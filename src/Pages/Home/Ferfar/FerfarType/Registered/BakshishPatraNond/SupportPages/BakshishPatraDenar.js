...
const BakshishPatraDenar = ({
  ...
  const {
    ...
    resolver: yupResolver(
      yup.object().shape({
        ...
        userName: yup.string().required("बक्षीसपत्र देणारा निवडा"),
  ...
  const handleSave = async () => {
    if (isIndian == "india") {
      ...
      if (result && isUserIndAdd) {
        sendRequest(
          `${URLS?.BaseURL}/MutationAPIS/CreateBakshishPatraForGiver`,
          "POST",
          {
          ...
          (res) => {
            if (res?.Code == "1") {
              ...
              handleReset();
              getBakshishPatraDenarTableData();
            } else {
  ...
  const handleDelete = (id) => {
    if (responseData.length == 1) {
      Swal.fire({
        title: `<p style="font-size: 0.8em;">बक्षीसपत्र घेणारे सुद्धा डिलीट होतील !</p>`,
        html: '<span style="color: red;">डिलीट झाल्यानंतर पुन्हा नवीन बक्षीसपत्र देणारे-घेणारे भरावे लागतील</span>',
        position: "center",
        icon: "warning",
        ...
        if (result.isConfirmed) {
          sendRequest(
            `${URLS?.BaseURL}/MutationAPIS/DeleteBakshishPatraForGiver`,
            "POST",
            {
              mutationId: id,
              applicationId: applicationId,
            ...
            (res) => {
              if (res?.Code == "1") {
                ...
                Swal.fire(
                  "Deleted!",
                  "बक्षीसपत्र देणारा घेणारा डिलीट झालेला आहे",
                  "success",
                );
                getBakshishPatraDenarTableData();
                getBakshishPatraGhenarTableData();
              } else {
                errorToast(res?.Message);
              }
            },
  ...
  const getBakshishPatraDenarTableData = () => {
    sendRequest(
      `${URLS?.BaseURL}/MutationAPIS/GetBakshishPatraGiverInfo`,
      "POST",
      applicationId,
      (res) => {
        if (res?.Code == "1") {
  ...
  const getBakshishPatraGhenarTableData = () => {
    sendRequest(
      `${URLS?.BaseURL}/MutationAPIS/GetBakshishPatraTakerInfo`,
      "POST",
      applicationId,
      (res) => {
        if (res?.Code == "1") {
  ...
  return (
    <>
      ...
      <Grid item md={12}>
        <NotesPaper
          heading="बक्षीसपत्र देणाराची माहिती भरण्यासाठी आवश्यक सूचना"
      ...
      <Paper elevation={5} sx={{ p: 2, mt: 2 }} className="papermain">
        <Grid container spacing={1}>
          <Grid item md={12}>
            <h4 className="heading">बक्षीसपत्र देणार</h4>
          </Grid>
          <Grid item md={12}>
              ...
              render={({ field }) => (
                <>
                  ...
                  >
                    ...
                    {/* <MenuItem value="nanasaheb">
                      नानासाहेब विठ्ठल शिंदे
                    </MenuItem>
          ...
          <Grid item md={12}>
            <InputLabel className="inputlabel">
              <b>
                बक्षीसपत्र देणाराचे नाव <span> *</span> (इंग्रजी मध्ये)
              </b>
            </InputLabel>
            <Grid container justifyContent="space-between">
              <Grid item md={2}>
          ...
          <Grid item md={12}>
            <Grid container spacing={2}>
              ...
              <Grid item md={3}>
                <InputLabel className="inputlabel">
                  <b>बक्षीसपत्र देणाऱ्याच्या नावे क्षेत्र (चौ.मी.)</b>
                </InputLabel>
                <TextField
                  fullWidth
                  type="text"
              ...
              <Grid item md={3}>
                {radio == "yes" ? (
                  <>
                    <InputLabel className="inputlabel">
                      <b>बक्षीसपत्र दिलेले क्षेत्र (चौ.मी.)</b>
                    </InputLabel>
                    <TextField
                      fullWidth
                      size="small"
          ...
          <Grid container justifyContent="end" px={2} mt={2}>
            <Grid item>
              ...
              >
                बक्षीसपत्र घेणाऱ्याची माहिती भरा
              </Button>
            </Grid>
          </Grid>
        </Grid>
      ...
      <Grid item md={12} mt={3}>
        <TableContainer component={Paper} elevation={5}>
          <h3 style={{ marginLeft: 20 }}>बक्षीसपत्र देणार माहिती तक्ता</h3>
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell>बक्षीसपत्र देणाराचे नाव</TableCell>
                <TableCell>उर्फ नाव</TableCell>
                <TableCell>बक्षीसपत्र देणाऱ्याचा पत्ता</TableCell>
                <TableCell>मिळकत पत्रिके प्रमाणे क्षेत्र (चौ.मी.)</TableCell>
                <TableCell>
                  बक्षीसपत्र देणाऱ्याच्या नावे क्षेत्र (चौ.मी.)
                </TableCell>
                <TableCell>बक्षीसपत्र दिलेले क्षेत्र (चौ.मी.)</TableCell>
      ...
      {ghenarData.length > 0 && (
        <Grid item md={12} mt={3}>
          <TableContainer component={Paper} elevation={5}>
            ...
            >
              <h3 style={{ marginLeft: 20 }}>बक्षीसपत्र घेणार माहिती तक्ता</h3>
              <Button
                onClick={() => setActiveStep(1)}
                endIcon={<ArrowForwardRoundedIcon />}
              >
                आणखी बक्षीसपत्र घेणाऱ्याची माहिती भरा
              </Button>
            </div>
            <Table>
              <TableHead style={{ backgroundColor: "#F4F4F4" }}>
                <TableRow>
                  ...
                  <TableCell>बक्षीसपत्र घेणाराचा प्रकार</TableCell>
                  <TableCell>बक्षीसपत्र घेणाराचे नाव</TableCell>
                  <TableCell>बक्षीसपत्र घेणाराचा पत्ता</TableCell>
                  <TableCell>उर्फ नाव</TableCell>
...
export default BakshishPatraDenar;
