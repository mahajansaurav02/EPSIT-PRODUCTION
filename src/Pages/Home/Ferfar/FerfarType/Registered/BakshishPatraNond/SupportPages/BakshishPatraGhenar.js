...
const BakshishPatraGhenar = ({ applicationData }) => {
    ...
    if (userType == 1 && isMHProperty == "no" && isIndian == "india") {
      ...
      if (isUserNoMhProperty && isUserIndAdd && isUserDharak) {
        if (isMobileNoVerified) {
          sendRequest(
            `${URLS?.BaseURL}/MutationAPIS/CreateBakshishPatraForTaker`,
            "POST",
            {
              giver: giver,
  ...
  return (
    <>
      ...
      <Grid item md={12}>
        <NotesPaper
          heading="बक्षीसपत्र घेणारा आवश्यक सूचना"
      ...
      <Paper elevation={5} sx={{ p: 2, mt: 2 }} className="papermain">
        <Grid container spacing={2}>
          <Grid item md={12}>
            <h4 className="heading">बक्षीसपत्र घेणार</h4>
          </Grid>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid container spacing={2}>
                      <Grid item md={2}>
                        <InputLabel className="inputlabel">
                          <b>बक्षीसपत्र घेणाराचा प्रकार </b>
                          <span>*</span>
                        </InputLabel>
                        <Select
                          value={userType}
                  ...
                  {userType == 1 ? (
                    <Grid item md={12}>
                      {isMHProperty == "no" ? (
                        <UserNoMHProperty
                          heading="बक्षीसपत्र घेणाऱ्याची माहिती"
                          inputlabel="बक्षीसपत्र घेणाऱ्याचे नाव"
                ...
                responseData.map((val, i) => {
                  return (
                    <TableRow key={i}>
                      ...
                      {/* <TableCell>
                        {val?.dharak?.userdharak?.giftArea
                          ? val?.dharak?.userdharak?.giftArea
                          : val?.dharak?.companydharak?.giftArea}
                      </TableCell> */}
                      <TableCell>
...
export default BakshishPatraGhenar;
