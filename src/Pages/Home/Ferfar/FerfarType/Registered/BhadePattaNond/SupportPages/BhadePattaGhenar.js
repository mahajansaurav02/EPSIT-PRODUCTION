...
const BhadePattaGhenar = ({ setActiveStep }) => {
    ...
    <>
      <Paper elevation={5} sx={{ p: 2 }}>
        <Grid container spacing={2}>
          ...
          <Grid item md={12}>
            <UserAddress type="bhadePattaGhenar" />
          </Grid>
          ...
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell rowSpan={2}>भाडेपट्टा घेणाराचा प्रकार</TableCell>
                <TableCell colSpan={3}>भाडेपट्टा देणाऱ्याचे नाव</TableCell>
                ...
                <TableCell rowSpan={2}>भाडेपट्टा क्षेत्र (चौ.मी.)</TableCell>
                <TableCell rowSpan={2}>भाडेपट्टा घेणाराचा पत्ता</TableCell>
