...
const GahankhatTaranBojaGhenara = ({ applicationData, setActiveStep }) => {
  ...
  const {
    ...
    resolver: yupResolver(
      yup.object().shape({
        ...
        userName: yup.string().required("खरेदी घेणारा निवडा"),
  ...
  const handleDelete = (id) => {
    if (responseData.length == 1) {
      Swal.fire({
        title: `<p style="font-size: 0.8em;">गहाणखत / तारण / बोजा देणारे सुद्धा डिलीट होतील !</p>`,
        html: '<span style="color: red;">डिलीट झाल्यानंतर पुन्हा नवीन गहाणखत / तारण / बोजा देणारे-घेणारे भरावे लागतील</span>',
        position: "center",
        icon: "warning",
          ...
          sendRequest(
            ...
            (res) => {
              if (res?.Code == "1") {
                ...
                Swal.fire(
                  "Deleted!",
                  "गहाणखत / तारण / बोजा घेणारा देणारा डिलीट झालेला आहे",
                  "success",
                );
                getGahanKhatDenarTableData();
          ...
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell>गहाणखत / तारण / बोजा घेणाराचे नाव</TableCell>
                <TableCell>गहाणखत / तारण / बोजा घेणाराचा पत्ता</TableCell>
                <TableCell>उर्फ नाव</TableCell>
                <TableCell>मिळकत पत्रिके प्रमाणे क्षेत्र (चौ.मी.)</TableCell>
                <TableCell>
                  बोजा घेणाऱ्याच्या नावे उपलब्ध क्षेत्र (चौ.मी.)
                </TableCell>
...
export default GahankhatTaranBojaGhenara;
