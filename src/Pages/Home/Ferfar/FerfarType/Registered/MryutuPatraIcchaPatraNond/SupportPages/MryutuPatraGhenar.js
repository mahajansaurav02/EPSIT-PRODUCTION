...
import { mryutupatraGhenarNotesArr } from "../../../../../../../NotesArray/NotesArray";
                        ...
                        >
                          {Array.isArray(userTypeArr) &&
                            userTypeArr.map((val, i) => {
                              return (
                                <MenuItem value={val?.applicant_category_code}>
          ...
          <Table>
            <TableHead style={{ backgroundColor: "#F4F4F4" }}>
              <TableRow>
                ...
                <TableCell>खाते प्रकार</TableCell>
                ...
                <TableCell>लाभार्थी क्षेत्र (चौ.मी.)</TableCell>
                ...
                responseData.map((val, i) => {
                  return (
                    <TableRow key={i}>
                      ...
                      <TableCell>
                        {val?.userType == "PERSON" ? "व्यक्ति" : "कंपनी"}
                      </TableCell>
                      ...
                      <TableCell>
                        {val?.dharak?.userdharak?.khataType
                          ? val?.dharak?.userdharak?.khataType?.khataLabel
                          : val?.dharak?.companydharak?.khataType?.khataLabel}
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        {val?.dharak?.userdharak?.actualArea
                          ? val?.dharak?.userdharak?.actualArea
                          : "-"}
                      </TableCell>
                      <TableCell>
                        {val?.dharak?.userdharak?.benefitArea
                          ? val?.dharak?.userdharak?.benefitArea
                          : val?.dharak?.companydharak?.benefitArea}
                      </TableCell>
                      <TableCell>
